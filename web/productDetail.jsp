        ...
        <div class="product-info display-inline-flex">
            ...
            <div class="product-desc">
                ...
                <div class="order-qnt text-end p-20">
                    ...
                    <input class="font-1half qnt-input" type="number" id="qnt" maxlength="1"
                           max="<%=min(10,product.getStock())%>" min="1" value="1">
                </div>
                <div class="margin-top-15">
                    <a href="#" class="btn btn-info display-block product-link"
                       onclick="addToCart(<%=product.getPid()%>, <%=session.getAttribute("authorized")%>)"> <fmt:message
                            key="product-add"/>
                        &raquo;</a>
                </div>
            </div>
